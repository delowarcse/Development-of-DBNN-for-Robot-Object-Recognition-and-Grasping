function varargout = ObjectExtractionNGrasping1(varargin)
% OBJECTEXTRACTIONNGRASPING1 MATLAB code for ObjectExtractionNGrasping1.fig
%      OBJECTEXTRACTIONNGRASPING1, by itself, creates a new OBJECTEXTRACTIONNGRASPING1 or raises the existing
%      singleton*.
%
%      H = OBJECTEXTRACTIONNGRASPING1 returns the handle to a new OBJECTEXTRACTIONNGRASPING1 or the handle to
%      the existing singleton*.
%
%      OBJECTEXTRACTIONNGRASPING1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OBJECTEXTRACTIONNGRASPING1.M with the given input arguments.
%
%      OBJECTEXTRACTIONNGRASPING1('Property','Value',...) creates a new OBJECTEXTRACTIONNGRASPING1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ObjectExtractionNGrasping1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ObjectExtractionNGrasping1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ObjectExtractionNGrasping1

% Last Modified by GUIDE v2.5 22-Nov-2015 17:26:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ObjectExtractionNGrasping1_OpeningFcn, ...
                   'gui_OutputFcn',  @ObjectExtractionNGrasping1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
%% --- Executes just before ObjectExtractionNGrasping1 is made visible.
function ObjectExtractionNGrasping1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ObjectExtractionNGrasping1 (see VARARGIN)
...
% Choose default command line output for ObjectExtractionNGrasping1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ObjectExtractionNGrasping1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


%% --- Outputs from this function are returned to the command line.
function varargout = ObjectExtractionNGrasping1_OutputFcn(hObject, eventdata, handles) 
...
% Robot Grasping
    ...
    ax = 160.5665;
    bx = 20; % to correct the robot position
    ax1 = 1.4009;
    %centroid(i,2);
