function varargout = GUIObjectRecognitionNGrasping_HU1(varargin)

% Only four objects recognition and robot grasping

% GUIOBJECTRECOGNITIONNGRASPING_HU1 MATLAB code for GUIObjectRecognitionNGrasping_HU1.fig
%      GUIOBJECTRECOGNITIONNGRASPING_HU1, by itself, creates a new GUIOBJECTRECOGNITIONNGRASPING_HU1 or raises the existing
%      singleton*.
%
%      H = GUIOBJECTRECOGNITIONNGRASPING_HU1 returns the handle to a new GUIOBJECTRECOGNITIONNGRASPING_HU1 or the handle to
%      the existing singleton*.
%
%      GUIOBJECTRECOGNITIONNGRASPING_HU1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIOBJECTRECOGNITIONNGRASPING_HU1.M with the given input arguments.
%
%      GUIOBJECTRECOGNITIONNGRASPING_HU1('Property','Value',...) creates a new GUIOBJECTRECOGNITIONNGRASPING_HU1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUIObjectRecognitionNGrasping_HU1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUIObjectRecognitionNGrasping_HU1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GUIObjectRecognitionNGrasping_HU1

% Last Modified by GUIDE v2.5 25-May-2016 10:16:10

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GUIObjectRecognitionNGrasping_HU1_OpeningFcn, ...
                   'gui_OutputFcn',  @GUIObjectRecognitionNGrasping_HU1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GUIObjectRecognitionNGrasping_HU1 is made visible.
function GUIObjectRecognitionNGrasping_HU1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GUIObjectRecognitionNGrasping_HU1 (see VARARGIN)
...
% Choose default command line output for GUIObjectRecognitionNGrasping_HU1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GUIObjectRecognitionNGrasping_HU1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GUIObjectRecognitionNGrasping_HU1_OutputFcn(hObject, eventdata, handles) 
...
if n == 4   % if no. of objects are 4
    ...
    if center == 1
        ...
        rectangle('Position',[centroid(1,1)-17,centroid(1,2)-18,36,36]);
    elseif center == 2
        Center_x = centroid(2,2);
        Center_y = centroid(2,1);
        Rotation = orientation(2);
        rectangle('Position',[centroid(2,1)-17,centroid(2,2)-18,36,36]);
    elseif center == 3
        Center_x = centroid(3,2);
        Center_y = centroid(3,1);
        Rotation = orientation(3);
        rectangle('Position',[centroid(3,1)-17,centroid(3,2)-18,36,36]);
    else
        Center_x = centroid(4,2);
        Center_y = centroid(4,1);
        Rotation = orientation(4);
        rectangle('Position',[centroid(4,1)-17,centroid(4,2)-18,36,36]);
    end
...
%             P2 = strcat('(',X,',',Y,',','135',',',Rx,',',Ry,',',Rz,',',fig,')');
%             rob.Move(1,P2);
